...
const dataModule = await import(
  pathToFileURL(path.join(root, 'src', 'features', 'catalog', 'data', 'products.js')).href
);
const products = dataModule.products;
if (!Array.isArray(products)) {
  throw new Error('Expected `products` array export from src/features/catalog/data/products.js');
}
