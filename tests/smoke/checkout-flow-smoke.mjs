...
const payoutText = fs.readFileSync(
  path.join(root, 'src', 'features', 'checkout', 'components', 'Payout.jsx'),
  'utf8'
);
const returnText = fs.readFileSync(
  path.join(root, 'src', 'features', 'checkout', 'components', 'CheckoutReturn.jsx'),
  'utf8'
);
